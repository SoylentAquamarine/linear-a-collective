...
3. Skeptic's check: is anything being believed without having survived falsification? In particular, is any language-identification claim resting on sign values that aren't actually borrowed-confident?
...
Collective projects, whose own steering-committee history is what shaped
