const REPO = 'SoylentAquamarine/linear-a-collective';
...
async function loadOverviewStats() {
  ...
  try {
    ...
    document.querySelector('#status-title').textContent = findings > 0
      ? 'Language-identification testing underway.'
      : 'Foundation laid. Corpus canonicalization and the sign-value confidence atlas are the first tasks.';
